	...
	<div class="card card-outline card-primary">
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-block btn-sm btn-default btn-flat border-primary new_work" href="javascript:void(0)"><i class="fa fa-plus"></i> Agregar Experiencia</a>
			</div>
		</div>
		<div class="card-body">
...
<script>
	$(document).ready(function() {
		...
		$('.delete_work').click(function() {
			_conf("Deseas eliminar esta experiencia?", "delete_work", [$(this).attr('data-id')])
		})
		$('#list').dataTable()
	})
