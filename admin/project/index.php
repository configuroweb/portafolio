	...
	<div class="card card-outline card-primary">
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-block btn-sm btn-default btn-flat border-primary new_project" href="javascript:void(0)"><i class="fa fa-plus"></i> Agregar Proyecto</a>
			</div>
		</div>
		<div class="card-body">
...
<script>
	$(document).ready(function() {
		...
		$('.delete_project').click(function() {
			_conf("Deseas eliminar este proyecto?", "delete_project", [$(this).attr('data-id')])
		})
		$('#list').dataTable()
	})
