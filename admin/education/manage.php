...
<div class="col-lg-12">
	<div class="card card-outline card-primary">
		<div class="card-header">
			<h5 class="card-title">Información de Educación</h5>
		</div>
		<div class="card-body">
			<form id="education">
				<div class="row" class="details">
					...
					<div class="col-sm-6">
						<div class="form-group">
							<label for="" class="control-label">Escuela</label>
		...
		<div class="card-footer">
			<button class="btn btn-primary btn-sm" form="education"><?php echo isset($_GET['id']) ? "Actualizar" : "Guardar" ?></button>
