	...
	<div class="card card-outline card-primary">
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-block btn-sm btn-default btn-flat border-primary new_education" href="javascript:void(0)"><i class="fa fa-plus"></i> Agregar Educación</a>
			</div>
		</div>
		<div class="card-body">
...
<script>
	$(document).ready(function() {
		...
		$('.delete_education').click(function() {
			_conf("Deseas eliminar esta información?", "delete_education", [$(this).attr('data-id')])
		})
		$('#list').dataTable()
	})
