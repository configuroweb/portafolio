			...
			<form id="contact">
				<div class="row">
					<div class="col-sm-6">
						...
						<div class="form-group">
							<label for="" class="control-label">Enlace de Facebook</label>
							<div class="input-group">
								<div class="input-group-prepend">
						...
						<div class="form-group">
							<label for="" class="control-label">Enlace de Twitter</label>
							<div class="input-group">
								<div class="input-group-prepend">
						...
						<div class="form-group">
							<label for="" class="control-label">Enlace de LinkedIn</label>
							<div class="input-group">
								<div class="input-group-prepend">
